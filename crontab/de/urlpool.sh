...
nohup go run /data/www/web/go/src/github.com/hunterhug/AmazonGo/spiders/de/urlpool.go  > /data/www/web/go/src/github.com/hunterhug/AmazonGo/sh/de/urlpool.log 2>&1
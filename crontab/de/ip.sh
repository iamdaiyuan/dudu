...
nohup go run /data/www/web/go/src/github.com/hunterhug/AmazonGo/spiders/de/ippool.go  > /data/www/web/go/src/github.com/hunterhug/AmazonGo/sh/de/ippool.log 2>&1 &
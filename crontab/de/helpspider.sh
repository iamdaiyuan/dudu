...
nohup go run /data/www/web/go/src/github.com/beautytop/dudu/spiders/de/listmain.go  > /data/www/web/go/src/github.com/beautytop/dudu/sh/de/listmain.log 2>&1 &
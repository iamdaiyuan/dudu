...
nohup go run /data/www/web/go/src/github.com/beautytop/dudu/spiders/de/asinmain.go  > /data/www/web/go/src/github.com/beautytop/dudu/sh/de/asinmain.log 2>&1 &
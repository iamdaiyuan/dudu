...
nohup go run /data/www/web/go/src/github.com/hunterhug/AmazonGo/spiders/de/asinmain.go  > /data/www/web/go/src/github.com/hunterhug/AmazonGo/sh/de/asinmain.log 2>&1 &
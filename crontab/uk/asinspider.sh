...
nohup go run /data/www/web/go/src/github.com/hunterhug/AmazonGo/spiders/uk/asinmain.go  > /data/www/web/go/src/github.com/hunterhug/AmazonGo/sh/uk/asinmain.log 2>&1 &
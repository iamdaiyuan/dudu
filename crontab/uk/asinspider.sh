...
nohup go run /data/www/web/go/src/github.com/beautytop/dudu/spiders/uk/asinmain.go  > /data/www/web/go/src/github.com/beautytop/dudu/sh/uk/asinmain.log 2>&1 &
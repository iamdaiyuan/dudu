...
nohup go run /data/www/web/go/src/github.com/hunterhug/AmazonGo/spiders/uk/ippool.go  > /data/www/web/go/src/github.com/hunterhug/AmazonGo/sh/uk/ippool.log 2>&1 &
...
nohup go run /data/www/web/go/src/github.com/hunterhug/AmazonGo/spiders/uk/listmain.go  > /data/www/web/go/src/github.com/hunterhug/AmazonGo/sh/uk/listmain.log 2>&1 &
...
nohup go run /data/www/web/go/src/github.com/beautytop/dudu/spiders/uk/listmain.go  > /data/www/web/go/src/github.com/beautytop/dudu/sh/uk/listmain.log 2>&1 &
...
nohup go run /data/www/web/go/src/github.com/beautytop/dudu/spiders/jp/listmain.go  > /data/www/web/go/src/github.com/beautytop/dudu/sh/jp/listmain.log 2>&1 &
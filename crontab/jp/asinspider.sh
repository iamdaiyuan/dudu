...
nohup go run /data/www/web/go/src/github.com/beautytop/dudu/spiders/jp/asinmain.go  > /data/www/web/go/src/github.com/beautytop/dudu/sh/jp/asinmain.log 2>&1 &
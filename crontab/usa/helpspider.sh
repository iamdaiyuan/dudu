...
nohup go run /data/www/web/go/src/github.com/beautytop/dudu/spiders/usa/listmain.go  > /data/www/web/go/src/github.com/beautytop/dudu/sh/usa/listmain.log 2>&1 &
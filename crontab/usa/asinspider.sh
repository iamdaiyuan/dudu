...
nohup go run /data/www/web/go/src/github.com/beautytop/dudu/spiders/usa/asinmain.go  > /data/www/web/go/src/github.com/beautytop/dudu/sh/usa/asinmain.log 2>&1 &